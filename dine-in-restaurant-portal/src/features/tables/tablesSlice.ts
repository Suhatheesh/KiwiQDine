...
import { CreateTableRequest, DeleteTableRequest, FetchAllTableResponse, FetchTablesRequest, InitialTableType, Table, UpdateTableRequest, UpdateTableStatusRequest } from "./types";
...
const tablesSlice = createSlice({
    ...
    reducers: {
        ...
        /* Delete Table */
        deleteTableRequest: (state, _: PayloadAction<DeleteTableRequest>) => {
            state.loading = true;
