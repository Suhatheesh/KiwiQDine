...
export class ItemService implements IItemService {
  ...
  async createItem(props: CreateItemDTO): Promise<Result<ITemResponseDTO>> {
    ...
    const itemModel: ItemEntity = this.itemMapper.toPersistence(item);
    ...
    const itemId: string = result.getValue().id;
  ...
  async getItemById(id: string): Promise<Result<ITemResponseDTO>> {
