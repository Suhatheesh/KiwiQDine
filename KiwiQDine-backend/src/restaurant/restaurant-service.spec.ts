...
import { Context, SingleClientany } from './../infrastructure';
...
describe('Test restaurant service', () => {
  ...
  const validateUserStub: IValidateUser<SingleClient, SingleClientany> =
    sinon.stubInterface<IValidateUser<SingleClient, SingleClientany>>();
  ...
  it('Should get Restaurants', async () => {
    ...
    restaurantMapperStub.toDomain(restaurantMockany);
